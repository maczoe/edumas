...
<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">Datos del ciclo escolar</h3>
    </div>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($period, ['method' => 'POST', 'route' => array('periods.store'), 'class' => 'form-horizontal']) !!}
    <div class="box-body ">
        <div class="row">
...
@section('custom_scripts')javascript"></script>
