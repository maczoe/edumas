    ...
    <div class="box-body ">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="col-lg-10">
                    {!! Form::text('start_date', $group->start_date->format('d/m/Y'), ['class'=>'form-control', 'id' => 'start_date']) !!}
                </div>
            </div>
            <div class="form-group col-md-6">
                {!! Form::label('end_date', 'Fecha final', ['class'=>'col-sm-2 control-label']) !!}
                <div class="col-lg-10">
                    {!! Form::text('end_date', $group->end_date->format('d/m/Y'), ['class'=>'form-control', 'id' => 'end_date']) !!}
                </div>
            </div>
        </div>
        <div class="row">
