...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($plan, ['method' => 'PATCH', 'route' => array('payment_plans.update', $plan->id), 'class' => 'form-horizontal']) !!}
    <div class="box-body ">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-10">
                        ...
                        {!! Form::text('pay_day', null, ['class'=>'form-control text-center', 'min'=>'1', 'max'=>'28']) !!}
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-lg-10">
                    <div class="input-group">
                        <span class="input-group-addon"><strong>Q</strong></span>
                    {!! Form::number('fault', null, ['class'=>'form-control', 'min'=>'0', 'step'=>'any']) !!}
                    </div>
                </div>
            </div>
        </div>
