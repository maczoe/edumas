...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Datos del grupo {{ $group->section }}:</h3>
    </div>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($group, ['method' => 'PATCH', 'route' => array('groups.update', $group->id), 'class' => 'form-horizontal']) !!}
        <div class="box-body ">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="col-lg-10">
                    {!! Form::select('daysWeek[]', ['1' => 'Lunes', '2' => 'Martes', '3' => 'Miércoles', '4' => 'Jueves', '5' => 'Viernes', '6' => 'Sábado', '7' => 'Domingo'], $group->daysWeek, ['class'=>'form-control select2', 'multiple'=>'multiple', 'style' =>'width: 100%;']) !!}
                </div>
            </div>
            <div class="form-group col-md-6">
