...
@section('contentheader_title')
    Muestra los datos del plan de pago
@endsection
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($plan, ['method' => 'POST', 'route' => array('payment_plans.update', $plan->id), 'class' => 'form-horizontal']) !!}
    <div class="box-body ">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="col-lg-10">
                    {!! Form::select('grade_id', $grades, null, ['class'=>'form-control select2', 'aria-hidden'=>'true', 'style' =>'width: 100%;', 'disabled']) !!}
                </div>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-10">
                        {!! Form::select('period', ['weekly' => 'Semanal', 'monthly' => 'Mensual', 'total' => 'Total', 'registration' => 'Inscripción'], null, ['class'=>'form-control select2', 'aria-hidden'=>'true', 'style' =>'width: 100%;', 'disabled']) !!}
                    </div>
                    <!-- /.input group -->
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-md-6">
                {!! Form::label('fault', 'Mora', ['class'=>'col-sm-2 control-label']) !!}
                <div class="col-lg-10">
                    <div class="input-group">
                        <span class="input-group-addon"><strong>Q</strong></span>
                    {!! Form::number('fault', null, ['class'=>'form-control', 'min'=>0, 'step'=>'any', 'disabled']) !!}
                    </div>
                </div>
            </div>
        </div>
