...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Datos de la clase {{ $class->name }}:</h3>
    </div>

    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($class, ['method' => 'POST', 'route' => array('classes.update', $class->id), 'class' => 'form-horizontal']) !!}
        <div class="box-body ">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <div class="col-lg-10">
                    {!! Form::select('teacher_id', $teachers, null, ['class'=>'form-control select2', 'aria-hidden'=>'true', 'style' =>'width: 100%;', 'disabled']) !!}
                </div>
            </div>
            <div class="form-group col-md-6">
                {!! Form::label('group_id', 'Grupo', ['class'=>'col-sm-2 control-label']) !!}
                <div class="col-lg-10">
                    {!! Form::select('group_id', $groups, null, ['class'=>'form-control select2', 'aria-hidden'=>'true', 'style' =>'width: 100%;', 'disabled']) !!}
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="bootstrap-timepicker">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            {!! Form::text('start_time', $class->start_time, ['class'=>'form-control timepicker', 'id' => 'start_time', 'disabled']) !!}
            ...
            <div class="form-group col-md-6">
                <div class="bootstrap-timepicker">
                    ...
                    <div class="col-lg-10">
                        <div class="input-group">
                            {!! Form::text('end_time', $class->end_time, ['class'=>'form-control timepicker', 'id' => 'end_time', 'disabled']) !!}
                            <div class="input-group-addon">
                                <i class="fa fa-clock-o"></i>
                            </div>
                        </div>
